...
const SESSION_USER  = "backenduser"
...
func (c *BaseController) GetSessionUser()*models.BackendUser{
	user:=c.GetSession(SESSION_USER)
	u:=user.(models.BackendUser)
	return &u
}
...
func (c *BaseController) checkLogin() {
	if strings.Compare(c.curUser.Id,"")==0 {
		//登录页面地址
...
func (c *BaseController) setBackendUser2Session(userId string) error {
