...
func GetServiceListChannel(client client.Interface,namespace string, numReads int) ServiceListChannel {
...
//	}
//	go func() {
//		list, err := client.ExtensionsV1beta1().Ingresses(nsQuery.ToRequestParam()).List(metaV1.ListOptions{})
...
//
//	go func() {
//		list, err := client.CoreV1().LimitRanges(nsQuery.ToRequestParam()).List(metaV1.ListOptions{})
//		for i := 0; i < numReads; i++ {
//			channel.List <- list
//			channel.Error <- err
//		}
...
func GetEventListChannelWithOptions(client client.Interface,namespace string,options metaV1.ListOptions) EventListChannel {
	...
	go func() {
		list, err := client.CoreV1().Events(namespace).List(options)
...
func GetEndpointListChannel(client client.Interface, nsQuery *NamespaceQuery, numReads int) EndpointListChannel {
	return GetEndpointListChannelWithOptions(client, nsQuery, metaV1.ListOptions{}, numReads)
}
...
//// numReads times.
func GetPodListChannel(client client.Interface, namespace string) PodListChannel {
	return GetPodListChannelWithOptions(client, namespace,ListEverything)
}
...
func GetPodListChannelWithOptions(client client.Interface, namespace string,options metaV1.ListOptions) PodListChannel {
	...
	go func() {
		...
		list, err := client.CoreV1().Pods(namespace).List(options)
...
func GetDeploymentListChannel(client client.Interface, namespace string) DeploymentListChannel {
	...
	go func() {
		...
		list, err := client.AppsV1beta2().Deployments(namespace).List(metaV1.ListOptions{})
...
func GetReplicaSetListChannelWithOptions(client client.Interface, namespace string,options metaV1.ListOptions) ReplicaSetListChannel {
	...
	go func() {
		list, err := client.AppsV1beta2().ReplicaSets(namespace).List(options)
...
// numReads times.
func GetDaemonSetListChannel(client client.Interface, namespace string, numReads int) DaemonSetListChannel {
	...
	go func() {
		list, err := client.AppsV1beta2().DaemonSets(namespace).List(metaV1.ListOptions{})
...
//
//	go func() {
//		list, err := client.BatchV1().Jobs(nsQuery.ToRequestParam()).List(metaV1.ListOptions{})
...
func GetCronJobListChannel(client client.Interface, namespace string, numReads int) CronJobListChannel {
	...
	go func() {
		list, err := client.BatchV1beta1().CronJobs(namespace).List(metaV1.ListOptions{})
...
func GetStatefulSetListChannel(client client.Interface,
	namespace string, numReads int) StatefulSetListChannel {
	...
	go func() {
		statefulSets, err := client.AppsV1beta2().StatefulSets(namespace).List(metaV1.ListOptions{})
...
//
//	go func() {
//		list, err := client.CoreV1().ConfigMaps(nsQuery.ToRequestParam()).List(metaV1.ListOptions{})
...
//
//	go func() {
//		list, err := client.CoreV1().Secrets(nsQuery.ToRequestParam()).List(metaV1.ListOptions{})
...
//
//	go func() {
//		list, err := client.RbacV1().Roles("").List(metaV1.ListOptions{})
//		for i := 0; i < numReads; i++ {
//			channel.List <- list
//			channel.Error <- err
//		}
...
//
//	go func() {
//		list, err := client.RbacV1().ClusterRoles().List(metaV1.ListOptions{})
//		for i := 0; i < numReads; i++ {
//			channel.List <- list
//			channel.Error <- err
//		}
...
//
//	go func() {
//		list, err := client.RbacV1().RoleBindings("").List(metaV1.ListOptions{})
//		for i := 0; i < numReads; i++ {
//			channel.List <- list
//			channel.Error <- err
//		}
...
//
//	go func() {
//		list, err := client.RbacV1().ClusterRoleBindings().List(metaV1.ListOptions{})
//		for i := 0; i < numReads; i++ {
//			channel.List <- list
//			channel.Error <- err
//		}
...
func GetPersistentVolumeListChannel(client client.Interface,
	...
	go func() {
		list, err := client.CoreV1().PersistentVolumes().List(metaV1.ListOptions{})
		for i := 0; i < numReads; i++ {
			channel.List <- list
			channel.Error <- err
		}
...
//
//	go func() {
//		list, err := client.CoreV1().PersistentVolumeClaims(nsQuery.ToRequestParam()).List(metaV1.ListOptions{})
//		for i := 0; i < numReads; i++ {
//			channel.List <- list
//			channel.Error <- err
//		}
...
//
//	go func() {
//		list, err := client.CoreV1().ResourceQuotas(nsQuery.ToRequestParam()).List(metaV1.ListOptions{})
//		for i := 0; i < numReads; i++ {
//			channel.List <- list
//			channel.Error <- err
//		}
...
// both must be read numReads times.
func GetHorizontalPodAutoscalerListChannel(client client.Interface, namespace string) HorizontalPodAutoscalerListChannel {
	channel := HorizontalPodAutoscalerListChannel{
		List:  make(chan *autoscaling.HorizontalPodAutoscalerList, 1),
		Error: make(chan error, 1),
	}

	go func() {
		list, err := client.AutoscalingV1().HorizontalPodAutoscalers(namespace).
			List(metaV1.ListOptions{})
		//for i := 0; i < numReads; i++ {
			channel.List <- list
			channel.Error <- err
