...
// NewGetAllReleasesParams creates a new GetAllReleasesParams object
// with the default values initialized.
func NewGetAllReleasesParams() GetAllReleasesParams {
	var ()
	return GetAllReleasesParams{}
}

// GetAllReleasesParams contains all the bound params for the get all releases operation
