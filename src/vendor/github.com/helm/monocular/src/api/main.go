...
import (
	...
	"github.com/helm/monocular/src/api/data/helm/client"
	"github.com/helm/monocular/src/api/handlers"
	"github.com/helm/monocular/src/api/handlers/charts"
	"github.com/helm/monocular/src/api/handlers/releases"
	"github.com/helm/monocular/src/api/handlers/repos"
	"github.com/helm/monocular/src/api/jobs"
	"github.com/helm/monocular/src/api/middleware"
